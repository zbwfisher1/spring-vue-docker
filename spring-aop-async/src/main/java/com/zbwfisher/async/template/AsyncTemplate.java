...
import com.zbwfisher.async.proxy.AsyncMethodProxy;
import com.zbwfisher.async.proxy.AsyncProxy;
import com.zbwfisher.async.proxy.AsyncResultProxy;
...
public class AsyncTemplate {
	...
	Type type = asyncFuture.getClass().getGenericInterfaces()[0];
        ...
        return (T) execute(asyncFuture,returnClass,timeout);
    }
